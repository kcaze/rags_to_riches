...
LOVE_VERSION = "11.2.0"
LOVE_WIN64 = "https://bitbucket.org/rude/love/downloads/love-11.2-win64.zip"
LOVE_OSX = "https://bitbucket.org/rude/love/downloads/love-11.2-macos.zip"
LOVE_LINUX = "https://bitbucket.org/rude/love/downloads/love-11.2-linux-x86_64.AppImage"
...
def build_linux():
	...
	urllib.urlretrieve(LOVE_LINUX, love_appimage)

	# Download AppImageTool
	appimage_tool = os.path.join(TMP_DIR, 'appimagetool-x86_64.AppImage')
	urllib.urlretrieve(APP_IMAGE_TOOL, appimage_tool)
...
def build_windows():
	...
	love_zip = os.path.join(TMP_DIR, "love.zip")
	urllib.urlretrieve(LOVE_WIN64, love_zip)
